...
<head>
    ...
    <title>RSM - Manage Marathons</title>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover table-striped">
                            ...
                            <tr class="active">
                                ...
                                <td><?= $race['race_location'] ?></td>
                                <td><?= $race['race_date_time'] ?></td>
                                <td>
                                    <a href="/site/admin/update_race/<?= $race['race_id'] ?>">Edit</a>
                                    |
                                    <a href="/site/admin/delete_race/<?= $race['race_id'] ?>">Delete</a>
                                </td>
                            </tr>
                            <?php }//End Foreach ?>
                            </tbody>
